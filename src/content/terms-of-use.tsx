...
export const termsOfUseData = [
  {
    description: (
      <>
        ...
        offered on or through tagion.org ("Website").
        <br />
  ...
  {
    title: "Who May Use the Websites",
    description: (
      <>
  ...
  {
    title: "Accessing the Websites and Account Security",
    description: (
      <>
        ...
        personal information on to the Websites on a public or shared computer
  ...
  },
  {
    ...
    description: (
      <>
        ...
        thereof), are owned by the DECARD, its licensors or other providers of
        ...
        <ul className={cx("list", { withoutMargin: true })}>
          <li>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <span className={cx("link")} onClick={() => sendEmail()}>
          info@tagion.org
        </span>
        .
        <br />
        ...
        expressly granted are reserved by the Entity. Any use of the Websites
  ...
  },
  {
    ...
    description: (
      <>
        The term DECARD, the DECARD logo and all related names, logos, product
        and service names, designs and slogans are trademarks of the Entity or
        its affiliates or licensors. You must not use such marks without the
        prior written permission of the Entity. All other names, logos, product
        and service names, designs and slogans on this Websites are the
    ...
    description: (
      <>
        ...
        <ul className={cx("list")}>
          ...
          <li>
            To impersonate or attempt to impersonate the DECARD, a DECARD
  ...
  },
  {
    ...
    description: (
      <>
        ...
        provided by the DECARD, are solely the opinions and the responsibility
        of the person or entity providing those materials. These materials do
        not necessarily reflect the opinion of the DECARD. We are not
  ...
  {
    title: "Information About You and Your Visits to the Websites",
    description: (
      <>
  ...
  {
    title: "Linking to the Websites and Social Media Features",
    description: (
      <>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        EITHER EXPRESS OR IMPLIED. NEITHER THE FOUNDATION NOR ANY PERSON
  ...
  },
  {
    ...
    description: (
      <>
        No waiver of by the DECARD of any term or condition set forth in these
        ...
        of the DECARD to assert a right or provision under these Terms of Use
  ...
  },
  {
    ...
    description: (
      <>
        ...
        you and the DECARD with respect to the Websites and supersede all prior
